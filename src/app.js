...
(function () {
  ...
  var NSX_CONFIG = {
    ...
    /* ---- CHECKOUT --------------------------------------------------
       ...
       mode: 'link'  -> button becomes a plain link. Drop in a YooKassa /
                        Tinkoff / Tilda payment URL and you are done.
       mode: 'tilda' -> button pushes the product into Tilda's own cart, so
                        it uses whichever gateway is connected to your Tilda
                        account (YooKassa, Tinkoff, Robokassa, CloudPayments).
                        Needs a Store block (ST100 / T754) on the page - see
                        README.
    ------------------------------------------------------------------ */
    checkout: {
      mode: 'link',
      url: '',                                          // <<REPLACE>> checkout URL
      tilda: {
        id: 'nsx-memori-01',
